...
{
    public sealed class RenderModelEndpoint : ICompiledEndpoint
    {
        private IConfiguration? _configuration;

        public string Route => "/rendermodel";
        public string ScriptName => "Model";
        ...
        public IDictionary<string, string> MapParameters(HttpRequest req)
        {
            ...
            Console.WriteLine($"[RenderModel] assetId={assetId}, x={x}, y={y}, assetUrl={assetUrl}");
