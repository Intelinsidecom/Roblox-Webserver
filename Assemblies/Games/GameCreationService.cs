        ...
        if (thumbnailService != null)
        {
            ...
            _ = Task.Run(async () =>
            {
                try
                {
                    ...
                    await PlaceThumbnail.GeneratePlaceThumbnailAsync(thumbnailService, connectionString, rootPlaceId, placeAssetHash, GetThumbnailBaseUrl(configuration), placeName: placeName, cancellationToken: cancellationToken);

                    // Generate 720p auto-generated thumbnail for the place
                    await PlaceThumbnail.GenerateAutoGeneratedThumbnailAsync(thumbnailService, connectionString, rootPlaceId, placeAssetHash, GetThumbnailBaseUrl(configuration), cancellationToken);
