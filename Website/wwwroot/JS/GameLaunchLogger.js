...
Roblox.GameLaunchLogger=function() {
    ...
    return $(function() {
            var n=[Roblox.GameLauncher.startClientAttemptedEvent, Roblox.GameLauncher.startClientFailedEvent, Roblox.GameLauncher.startClientSucceededEvent, Roblox.GameLauncher.beginInstallEvent, Roblox.GameLauncher.successfulInstallEvent, Roblox.GameLauncher.manualDownloadEvent]; $(Roblox.GameLauncher).on(n.join(" "), o)

        }),
    i= {}

    ,
    i[Roblox.GameLauncher.startClientAttemptedEvent]=["GameLaunchAttempt_<os>",
    "GameLaunchAttempt_<os>_<launchmethod>"],
    i[Roblox.GameLauncher.startClientSucceededEvent]=["GameLaunchSuccessWeb_<os>",
