...
Roblox = window.Roblox || {}, Roblox.GameLauncher = function() {
    ...
    function u(t) {
        ...
        return n.prerollPlayer.waitForPreroll(i).then(n.gameLaunchInterface.playTogether)
    }
    ...
    function i(n, t) {
        ...
        }, Roblox.CharacterSelect.modalOpacity = 80, Roblox.CharacterSelect.show()
    }

    function r(n) {
        var r = "gameDetails",
            i;
        Roblox.FormEvents && Roblox.FormEvents.SendInteractionClick(r, n), i = t.signupUrl + encodeURIComponent(window.location.pathname + window.location.search), window.location.href = Roblox && Roblox.Endpoints ? Roblox.Endpoints.getAbsoluteUrl(i) : i
    }
    ...
    function h(f) {
        ...
        return $("#PlaceLauncherStatusPanel").data("is-user-logged-in") == "True" ? (s.resolve(f), s) : (h = "/game/require-auth", c = Roblox && Roblox.Endpoints ? Roblox.Endpoints.getAbsoluteUrl(h) : h, $.get(c, null, function(h) {
            var c = h && h.RequireAuth,
                l;
            c && h.AbTestToDisplay === u.removeGuestMode ? Roblox.Dialog.open({
                titleText: t.dialogTitle,
                bodyContent: t.dialogContent,
                cssClass: t.modalClassName,
                acceptColor: Roblox.Dialog.green,
                acceptText: t.acceptText,
                declineText: t.declineText,
                onDecline: function() {
                    Roblox.FormEvents && Roblox.FormEvents.SendInteractionClick(t.eventContext, t.loginField);
                    var n = t.loginUrl + encodeURIComponent(window.location.pathname + window.location.search);
                    window.location.href = Roblox && Roblox.Endpoints ? Roblox.Endpoints.getAbsoluteUrl(n) : n
                },
                onAccept: function() {
                    r(t.signupField)
                }
            }) : c && h.AbTestToDisplay === u.limitedGuestModeCalculatedInDays ? h.DaysLeft <= 0 ? Roblox.Dialog.open({
                titleText: n.dialogTitleOver,
                bodyContent: n.dialogContentOver,
                acceptText: n.acceptText,
                declineText: n.declineTextOver,
                onAccept: function() {
                ...
                titleText: n.dialogTitleCountdown,
                bodyContent: n.dialogContentForDaysPt1 + h.DaysLeft + l,
                acceptText: n.acceptText,
                declineText: n.declineTextCountdown,
                onAccept: function() {
                    r(n.signupFieldForDays)
                },
                onDecline: function() {
                ...
                titleText: n.dialogTitleCountdown,
                bodyContent: n.dialogContentForPlaysPt1 + h.PlaysLeft + n.dialogContentForPlaysPt2,
                acceptText: n.acceptText,
                declineText: n.declineTextCountdown,
                onAccept: function() {
                    r(n.signupFieldForPlays)
    ...
    var t = {
            ...
            dialogTitle: "Sign up for a free account or log in!",
            dialogContent: "To play games, chat with friends, or customize your avatar, you'll need an account. Sign up for a free account or log in to play now.",
            acceptText: "Sign Up",
            declineText: "Log In",
            loginUrl: "/newlogin?returnurl=",
            signupUrl: "/account/signupredir?returnurl=",
        ...
        n = {
            ...
            dialogContentForDaysPt1: "You are playing in guest mode. To use all features available on Roblox, you will need to create an account. You have less than ",
            dialogContentForDaysPt2Plural: " days left before we require free sign up.",
            dialogContentForDaysPt2Single: " day left before we require free sign up.",
            dialogContentForPlaysPt1: "You are playing in guest mode. To use all features available on Roblox, you will need to create an account. You have ",
            dialogContentForPlaysPt2: " gameplays left before we require free sign up.",
            dialogTitleOver: "Trial Over!",
            dialogContentOver: "Your trial period has ended. Please sign up to play games - it's free!",
            acceptText: "Sign up now!",
            declineTextCountdown: "OK",
            declineTextOver: "Close",
            signupFieldForDays: "gameLaunch_signup_limitedGuestDays",
            signupFieldForPlays: "gameLaunch_signup_limitedGuestPlays",
            lastPopUpDateKey: "LimitedGuestModeLastPopUpDate",
            playCountPopUpFrequency: 5
        },
        u = {
            removeGuestMode: 1,
            limitedGuestModeCalculatedInDays: 2,
            limitedGuestModeCalculatedInPlays: 3
        };
    return f = {
    ...
    listenToIsPartyLeader: function() {
        $(document).on("Roblox.Party.IsPartyLeader", function(n, t) {
            var i = t.isPartyLeader ? Roblox.PartyInterface.isPartyLeaderEnabled : Roblox.PartyInterface.isPartyLeaderDisabled;
            Roblox.PartyInterface.gameDetailsPageSelector.attr(Roblox.PartyInterface.dataAttributeName, i)
        })
    }
