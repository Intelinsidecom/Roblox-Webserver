...
Freebloxia = Freebloxia || {}, Freebloxia.Performance = function() {
    function p() {
    ...
    function f() {
        ...
        return Freebloxia.EventStream && n && n != 0 && Math.random() < n && "performance" in window && "timing" in window.performance && "navigation" in window.performance
    }
    ...
    function s() {
        ...
        if (n && n.length > 0) {
            ...
            Freebloxia.EventStream.SendEventWithTarget("pagePerformance", i, u, Freebloxia.EventStream.TargetTypes.WWW)
        }
    }
