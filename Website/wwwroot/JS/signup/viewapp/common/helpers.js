...
"use strict";
var freebloxiaHelpers = angular.module("freebloxiaApp.helpers", []).directive("focusMe", ["$timeout", function (n) {
    return {
        scope: {
            trigger: "@focusMe"
        },
...
}).directive("imageRetry", ["freebloxiaImagesService", "$log", function (n) {
    return {
        restrict: "A",
        scope: {
            thumbnail: "="
    ...
    return {
        ...
        link: function (n, t, i, r) {
            n.$watch(function () {
                ...
                var u, t, i, f;
                typeof Freebloxia.FormEvents != "undefined" && (u = r[0], t = r[1], t.$dirty && t.$invalid && (i = [], angular.forEach(t.$error, function (n, t) {
                    n === !0 && i.push(t)
                }), f = t.redactedInput ? "[Redacted]" : n, Freebloxia.FormEvents.SendValidationFailed(u.$name, t.$name, f, i.join(","))))
            })
        }
    }
