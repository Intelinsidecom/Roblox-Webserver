...
signupOrLogin.controller("SignupController", ["$scope", "$http", "displayService", "captchaService", "signupService", function(n, t, i, r, u) {
    n.signup = {}, n.signup.gender = Freebloxia.SignupOrLogin.GenderType.unknown, n.setGender = function(t, i) {
        ...
        if (n.signupForm.$valid && (n.signup.gender === Freebloxia.SignupOrLogin.GenderType.unknown || n.signup.gender === Freebloxia.SignupOrLogin.GenderType.male || n.signup.gender === Freebloxia.SignupOrLogin.GenderType.female) && n.isValidBirthday(n.signup.birthdayDay)) n.badSubmit = !1;
        else {
            n.badSubmit = !0;
            return
        }
    ...
    n.isSectionShown = f === !1, n.$on("display:updated", function(t, i) {
        n.isSectionShown = i === Freebloxia.SignupOrLogin.SectionType.signup, n.isSectionShown && (Freebloxia.SignupOrLoginIframe && Freebloxia.SignupOrLoginIframe.resizeFrame(Freebloxia.SignupOrLogin.SectionType.signup), Freebloxia.SignupOrLoginModal && Freebloxia.SignupOrLoginModal.resizeModal(Freebloxia.SignupOrLogin.SectionType.signup), n.signup = {}, n.badSubmit = !1, n.signupForm.$setPristine(), n.signupForm.$generalError = !1)
