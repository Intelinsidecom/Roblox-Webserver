...
signupOrLogin.controller("LoginController", ["$scope", "displayService", "captchaService", "loginService", function(n, t, i, r) {
    ...
    n.login = {}, n.badSubmit = !1, n.submitLogin = function(t) {
        ...
        n.isSectionShown = i === Freebloxia.SignupOrLogin.SectionType.login, n.isTwoStepSectionShown = i === Freebloxia.SignupOrLogin.SectionType.twostep, n.isSectionShown && (Freebloxia.SignupOrLoginIframe && Freebloxia.SignupOrLoginIframe.resizeFrame(Freebloxia.SignupOrLogin.SectionType.login), Freebloxia.SignupOrLoginModal && Freebloxia.SignupOrLoginModal.resizeModal(Freebloxia.SignupOrLogin.SectionType.login), n.badSubmit = !1, n.login = {}, n.twoStepVerification = {}, n.isSubmitting = !1, n.loginForm.$setPristine(), n.$generalError = !1, n.twoStepVerificationForm && (n.twoStepVerificationForm.twoStepCode.$validationMessage = "", n.twoStepVerificationForm.$setPristine()))
