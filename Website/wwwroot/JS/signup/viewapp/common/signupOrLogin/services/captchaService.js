...
signupOrLogin.factory("captchaService", ["$rootScope", "$http", function(n, t) {
    var i = Freebloxia.SignupOrLogin.CaptchaFlowType.signup,
        u = function(n, u, f) {
            var o = angular.element(n.target),
                ...
                e;
            if (f.captchaFlowType === Freebloxia.SignupOrLogin.CaptchaFlowType.signup) e = o.data("signup-captcha-api-url");
            else if (i === Freebloxia.SignupOrLogin.CaptchaFlowType.login) e = o.data("log-in-captcha-api-url"), h.username = f.username;
        ...
        r = function() {
            i == Freebloxia.SignupOrLogin.CaptchaFlowType.signup ? n.$broadcast("captcha:signupSuccess") : i == Freebloxia.SignupOrLogin.CaptchaFlowType.login && n.$broadcast("captcha:loginSuccess")
        };
    return {
