...
signupOrLogin.factory("loginService", ["$http", "captchaService", "displayService", function(n, t, i) {
    var r = function(r) {
            ...
            r.isSubmitting = !0, n({
                ...
                Freebloxia.SignupOrLogin.onLoginSuccess(n.userId)
            }).error(function(n, u) {
                u === 403 ? n.message === "Captcha" ? (r.isSubmitting = !1, r.isSectionShown = !1, i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.captcha), t.setCaptchaFlowType(Freebloxia.SignupOrLogin.CaptchaFlowType.login, r.login.username)) : n.message === "Privilege" ? (r.isSubmitting = !1, r.isSectionShown = !0, alert("Sorry, privileged accounts can't log in from here.")) : n.message === "TwoStepVerification" ? r.requestTwoStepCode() : n.message === "LoggedIn" ? window.location.reload() : n.message === "Credentials" ? (i.getDisplayState() !== Freebloxia.SignupOrLogin.SectionType.login && i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.login), r.isSubmitting = !1, r.loginForm.username.$validationMessage = "", r.loginForm.username.showValidation = !0, r.loginForm.password.$validationMessage = "Your credentials were incorrect.", r.loginForm.password.showValidation = !0) : (i.getDisplayState() !== Freebloxia.SignupOrLogin.SectionType.login && i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.login), r.isSubmitting = !1, r.$generalError = !0, r.$generalErrorText = "Sorry, an error occurred.") : (r.isSubmitting = !1, r.$generalError = !0, r.$generalErrorText = "Sorry, an error occurred.")
            })
        },
        u = function(t) {
            ...
            n({
                ...
                t.isSubmitting = !1, i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.twostep)
            }).error(function() {
                i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.login), t.isSubmitting = !1, t.$generalError = !0, t.$generalErrorText = "Sorry, an error occurred."
            })
        },
        f = function(t, i) {
