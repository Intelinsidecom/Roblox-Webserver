...
signupOrLogin.factory("signupService", ["$http", "captchaService", "displayService", "$rootElement", function(n, t, i) {
    var u = function(r) {
            ...
            typeof e == "undefined" && (e = {}), $.each(e, function(n, t) {
                ...
                Freebloxia.SignupOrLogin.onSignupSuccess(n.userId);
                ...
                if (username && password) {
                    $.ajax({
                        ...
                        success: function(t) {
                            if (t && t.userId) {
                                Freebloxia.SignupOrLogin.onLoginSuccess(t.userId);
                ...
                if (r.badSubmit = !0, r.isSubmitting = !1, u === 403) {
                    var f = 0;
                    n.reasons.indexOf("Captcha") !== -1 && (r.isSubmitting = !1, r.isSectionShown = !1, i.setDisplayState(Freebloxia.SignupOrLogin.SectionType.captcha), t.setCaptchaFlowType(Freebloxia.SignupOrLogin.CaptchaFlowType.signup), f += 1), n.reasons.indexOf("GenderInvalid") !== -1 && (r.signup.gender = 1, f += 1), n.reasons.indexOf("PasswordInvalid") !== -1 && (r.signupForm.password.$setValidity("password", !1), r.signupForm.password.$passwordMessage = "Password is invalid", f += 1), n.reasons.indexOf("UsernameInvalid") !== -1 && (r.signupForm.username.$setValidity("validusername", !1), r.signupForm.username.$usernameMessage = "Username is invalid", f += 1), n.reasons.indexOf("UsernameTaken") !== -1 && (r.signupForm.username.$setValidity("unique", !1), r.signupForm.username.$usernameMessage = "Username is taken", f += 1), f < n.reasons.length && (r.signupForm.$generalError = !0, r.signupForm.$generalErrorText = "Sorry, an error occurred.")
