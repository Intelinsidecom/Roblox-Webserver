...
(function(n, t) {
    ...
    function c(n) {
        for (var r, u = [], i = 0; i < n.length; i++) r = b(Freebloxia, l(n[i])), r !== t && u.push(r);
        return u
    }
    ...
    function nt(n, t, r) {
        k(t) ? (r = t, t = []) : s(t) || (t = [t]), i[n] = i[n] || {
            ...
            y(Freebloxia, n, r.apply(null, c(t)))
        }), h(t, function() {
    ...
    typeof Freebloxia == "undefined" && (Freebloxia = {}), Freebloxia.config = r, Freebloxia.require = h, Freebloxia.define = nt
})(window);