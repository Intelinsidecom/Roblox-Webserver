...
$(function() {
    ...
    function v() {
        if (Freebloxia && Freebloxia.RealTime) {
            var n = Freebloxia.RealTime.Factory.GetClient();
    ...
    var o = 99,
        c = 1e3,
        r = 1;
    $(document).on("Freebloxia.Messages.CountChanged", function() {
        var n = Freebloxia.websiteLinks.GetMyUnreadMessagesCountLink;
        $.ajax({
            url: n,
            success: function(n) {
                var r = $("#nav-message"),
    ...
    $(document).on("Freebloxia.Friends.CountChanged", function() {
        l()
    });
    ...
    $(".rbx-navbar-right").on("click touchstart", '[data-behavior="logout"]', function(n) {
        var i, t;
        n.stopPropagation(), n.preventDefault(), i = $(this), typeof angular == "undefined" || angular.isUndefined(angular.element("#chat-container").scope()) || (t = angular.element("#chat-container").scope(), t.$digest(t.$broadcast("Freebloxia.Chat.destroyChatCookie"))), $.post(i.attr("data-bind"), {
            redirectTohome: !1
        }, function() {
            var t = Freebloxia && Freebloxia.Endpoints ? Freebloxia.Endpoints.getAbsoluteUrl("/") : "/";
    ...
    var f = function() {
        $("#header-login").click(function(evt) {
            var hasSignupOrLogin = window.Freebloxia && Freebloxia.SignupOrLogin && Freebloxia.SignupOrLogin.SectionType;
            var hasModal = window.Freebloxia && Freebloxia.SignupOrLoginModal && typeof Freebloxia.SignupOrLoginModal.show === "function";
            ...
            if (hasSignupOrLogin && hasModal) {
                var t = {
                    ...
                    sectionType: Freebloxia.SignupOrLogin.SectionType.login
                };
                Freebloxia.SignupOrLoginModal.show(t)
            } else {
            ...
            var t = {
                ...
                sectionType: Freebloxia.SignupOrLogin.SectionType.signup
            };
            Freebloxia.SignupOrLoginModal.show(t)
        })
    },
