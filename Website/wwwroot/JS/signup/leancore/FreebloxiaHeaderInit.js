...
Freebloxia = Freebloxia || {}, Freebloxia.Performance = function() {
    ...
    function v() {
        ...
        return Freebloxia.EventStream && n && n != 0 && Math.random() < n && r()
    }
    ...
    function u(n) {
        ...
        if (n && n.length > 0) {
            ...
            Freebloxia.EventStream.SendEventWithTarget("pagePerformance", i, r, Freebloxia.EventStream.TargetTypes.WWW)
        }
    }
