/* dist/js/legacyStyleGuide.bundle.min.js */ ! function(n) {
    var o = {};
    ...
    137: function(t, e, n) {
        ...
        }(0, r.importFilesUnderPath)(n(43));
        var i = n(45);
        (0, r.templateCacheGenerator)(o.default, "toastHtmlTemplate", i)
    },
    138: function(t, e, n) {},
    18: function(t, e) {
        t.exports = angular
    ...
    23: function(t, e, n) {
        ...
        var o, r = n(18);
        var u = ((o = r) && o.__esModule ? o : {
            default: o
        }).default.module("toast", ["toastHtmlTemplate"]);
        e.default = u
    },
    42: function(t, e, n) {
        "use strict";
    ...
    44: function(t, e, n) {
            ...
            return {
                ...
                link: function(n, t, e) {
                    n.layout = {
                        ...
                        visibilityDelay: 50
                    }, n.$watch("toastLayout.isNeeded", function(t, e) {
                        t !== e && t && !n.layout.timeout && (n.layout.text = n.toastLayout.text, n.layout.isEnabled = t, n.toastLayout.isNeeded = !1, o(function() {
                            n.layout.isVisible = !0
                        }, n.layout.visibilityDelay), n.layout.timeout = o(function() {
                            n.layout.isVisible = !1, o(function() {
        ...
        i.$inject = ["$timeout"], u.default.directive("toast", i), e.default = i
    },
    45: function(t, e, n) {
        var o = {
            "./directives/templates/toast.html": 46
        };
