...
TWEEN.Tween = function(n) {
    ...
    this.to = function(n, i) {
        return i !== undefined && (d = i), t = n, this
    }, this.start = function(n) {
        TWEEN.add(this), y = !0, c = !1, e = n !== undefined ? n : typeof window != "undefined" && window.performance !== undefined && window.performance.now !== undefined ? window.performance.now() : Date.now(), e += a;
        for (var f in t) {
            if (t[f] instanceof Array) {
                if (t[f].length === 0) continue;
                t[f] = [i[f]].concat(t[f])
            }
            r[f] = i[f], r[f] instanceof Array == !1 && (r[f] *= 1), u[f] = r[f] || 0
        }
        return this
    }, this.stop = function() {
        ...
        var v, w, nt, tt, y, rt, it, ut;
        if (n < e) return !0;
        c === !1 && (l !== null && l.call(i), c = !0), w = (n - e) / d, w = w > 1 ? 1 : w, nt = g(w);
        for (v in t) tt = r[v] || 0, y = t[v], y instanceof Array ? i[v] = b(y, nt) : (typeof y == "string" && (y = tt + parseFloat(y, 10)), typeof y == "number" && (i[v] = tt + (y - tt) * nt));
        if (h !== null && h.call(i, nt), w == 1) {
            if (o > 0) {
                isFinite(o) && o--;
                for (v in u) typeof t[v] == "string" && (u[v] = u[v] + parseFloat(t[v], 10)), p && (rt = u[v], u[v] = t[v], t[v] = rt), r[v] = u[v];
                return p && (k = !k), e = n + a, !0
            }
