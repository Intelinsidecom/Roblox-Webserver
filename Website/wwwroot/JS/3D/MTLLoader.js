...
THREE.MTLLoader = function(n, t) {
    this.options = n, this.crossOrigin = t
    ...
    load: function(n, t, i, r) {
        ...
        u.setCrossOrigin(this.crossOrigin), u.load(n, function(n) {
            t(f.parse(n))
        }, function() {}, r)
    },
    parse: function(n) {
        for (var h = n.split("\n"), u = {}, l = /\s+/, c = {}, t, f, i, r, o, s, e = 0; e < h.length; e++)(t = h[e], t = t.trim(), t.length !== 0 && t.charAt(0) !== "#") && (f = t.indexOf(" "), i = f >= 0 ? t.substring(0, f) : t, i = i.toLowerCase(), r = f >= 0 ? t.substring(f + 1) : "", r = r.trim(), i === "newmtl" ? (u = {
            name: r
        }, c[r] = u) : u && (i === "ka" || i === "kd" || i === "ks" ? (o = r.split(l, 3), u[i] = [parseFloat(o[0]), parseFloat(o[1]), parseFloat(o[2])]) : u[i] = r));
        return s = new THREE.MTLLoader.MaterialCreator(this.options), s.setMaterials(c), s
    }
}, THREE.MTLLoader.MaterialCreator = function(n) {
    this.options = n, this.materialsInfo = {}, this.materials = {}, this.materialsArray = [], this.nameLookup = {}, this.side = this.options && this.options.side ? this.options.side : THREE.FrontSide, this.wrap = this.options && this.options.wrap ? this.options.wrap : THREE.RepeatWrapping
}, THREE.MTLLoader.MaterialCreator.prototype = {
    constructor: THREE.MTLLoader.MaterialCreator,
    setMaterials: function(n) {
        this.materialsInfo = this.convert(n), this.materials = {}, this.materialsArray = [], this.nameLookup = {}
    },
    getHashUrl: function(n) {
        if (!n || n.length !== 32 || n.indexOf("/") >= 0) return n;
        var e = document.querySelector("[obj-loader-cdn-url]"),
        ...
        for (r in n) {
            ...
            for (e in u) {
                ...
                switch (s) {
                    ...
                    case "ka":
                    case "ks":
                        this.options && this.options.normalizeRGB && (t = [t[0] / 255, t[1] / 255, t[2] / 255]), this.options && this.options.ignoreZeroRGBs && t[0] === 0 && t[1] === 0 && t[1] === 0 && (o = !1);
                        break;
                    case "d":
    ...
    createMaterial_: function(n) {
        ...
        for (r in u) {
            ...
            switch (r.toLowerCase()) {
                ...
                case "ks":
                    ...
                    break;
                case "map_kd":
                    t.map = this.loadTexture(this.getHashUrl(i)), t.map.wrapS = this.wrap, t.map.wrapT = this.wrap;
                    break;
                case "ns":
                    t.shininess = i;
                    break;
        ...
        return t.shininess = 0, this.materials[n] = new THREE.MeshPhongMaterial(t)
    },
    loadTexture: function(n, t, i, r) {
        ...
        if (s) u = THREE.ImageUtils.loadCompressedTexture(n, t, i, r);
            ...
            function y(n) {
                u.image = THREE.MTLLoader.ensurePowerOfTwo_(n), u.needsUpdate = !0, i && i(u)
            }
            o()
        }
        return u
