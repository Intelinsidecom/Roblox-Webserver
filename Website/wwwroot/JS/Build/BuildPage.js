...
typeof Roblox == "undefined" && (Roblox = {}), typeof Roblox.BuildPage == "undefined" && (Roblox.BuildPage = {}), $(function () {
    ...
    function a(n5, r5) {
        ...
        var e = u5.closest("table"),
            ...
            dropdownSelector = e.data("dropdown"),
            isItemDropdown = !!dropdownSelector,
            dropdown = dropdownSelector ? $(dropdownSelector) : r5;
        ...
        if (!isItemDropdown) {
            ...
            dropdown.find("a").each(function () {
                ...
                n.hasClass("shutdown-all-servers-button") && (e.data("type") == "universes" ? n.attr("data-universe-id", e.attr("data-universeid")).removeAttr("data-place-id") : n.attr("data-place-id", f).removeAttr("data-universe-id"));
    ...
    $("body").on("click", "a.shutdown-all-servers-button[data-universe-id]", function () {
        return l("/universes/shutdown-all-games", {
            universeId: $(this).attr("data-universe-id")
        }), !1
    });
