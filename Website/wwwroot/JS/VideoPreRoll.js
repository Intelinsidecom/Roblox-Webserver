...
function flashCheck(n) {
    var t = !1,
        i, r;
    if (navigator.plugins && navigator.mimeTypes.length > 0) i = navigator.plugins["Shockwave Flash"], i && (r = navigator.plugins["Shockwave Flash"].description.replace(/.*\s(\d+\.\d+).*/, "$1"), r >= n && (t = !0));
    else try {
