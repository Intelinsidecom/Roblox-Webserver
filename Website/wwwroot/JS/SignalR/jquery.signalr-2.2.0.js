// SignalR/jquery.signalr-2.2.0.js
/*!
...
(function(n, t, i) {
    ...
    r = function(n, t, i) {
    ...
    }, r.events = u, r.resources = f, r.ajaxDefaults = v, r.changeState = o, r.isDisconnecting = p, r.connectionState = {
        connecting: 0,
        connected: 1,
        reconnecting: 2,
        disconnected: 4
        ...
        init: function(t, i, r) {
            ...
            this.url = t, this.qs = i, this.lastError = null, this._ = {
                keepAliveData: {},
                connectingMessageBuffer: new d(this, function(n) {
        ...
        start: function(i, h) {
            ...
            if (n.type(i) === "function" ? h = i : n.type(i) === "object" && (n.extend(v, i), n.type(v.callback) === "function" && (h = v.callback)), v.transport = b(v.transport, l), !v.transport) throw new Error("SignalR: Invalid transport(s) specified, aborting start.");
            return (l._.config = v, !s && v.waitForPageLoad === !0) ? (l._.deferredStartHandler = function() {
                l.start(i, h)
            }, e.bind("load", l._.deferredStartHandler), y.promise()) : l.state === r.connectionState.connecting ? y.promise() : o(l, r.connectionState.disconnected, r.connectionState.connecting) === !1 ? (y.resolve(l), y.promise()) : (w(l), p.href = l.url, p.protocol && p.protocol !== ":" ? (l.protocol = p.protocol, l.host = p.host) : (l.protocol = t.document.location.protocol, l.host = p.host || t.document.location.host), l.baseUrl = l.protocol + "//" + l.host, l.wsProtocol = l.protocol === "https:" ? "wss://" : "ws://", v.transport === "auto" && v.jsonp === !0 && (v.transport = "longPolling"), l.url.indexOf("//") === 0 && (l.url = t.location.protocol + l.url, l.log("Protocol relative URL detected, normalizing it to '" + l.url + "'.")), this.isCrossDomain(l.url) && (l.log("Auto detected cross domain url."), v.transport === "auto" && (v.transport = ["webSockets", "serverSentEvents", "longPolling"]), typeof v.withCredentials == "undefined" && (v.withCredentials = !0), v.jsonp || (v.jsonp = !n.support.cors, v.jsonp && l.log("Using jsonp because this browser doesn't support CORS.")), l.contentType = r._.defaultContentType), l.withCredentials = v.withCredentials, l.ajaxDataType = v.jsonp ? "jsonp" : "text", n(l).bind(u.onStart, function() {
                n.type(h) === "function" && h.call(l), y.resolve(l)
            }), l._.initHandler = r.transports._logic.initHandler(l), d = function(i, s) {
                var c = r._.error(f.noTransportOnInit);
                if (s = s || 0, s >= i.length) {
                    s === 0 ? l.log("No transports supported by the server were selected.") : s === 1 ? l.log("No fallback transports were selected.") : l.log("Fallback transports exhausted."), n(l).triggerHandler(u.onError, [c]), y.reject(c), l.stop();
                    return
                }
                if (l.state !== r.connectionState.disconnected) {
                    ...
                    l.transport = h;
                    try {
                        l._.initHandler.start(h, function() {
                            var i = r._.firefoxMajorVersion(t.navigator.userAgent) >= 11,
                                f = !!l.withCredentials && i;
                            l.log("The start request succeeded. Transitioning to the connected state."), a(l) && r.transports._logic.monitorKeepAlive(l), r.transports._logic.startHeartbeat(l), r._.configurePingInterval(l), o(l, r.connectionState.connecting, r.connectionState.connected) || l.log("WARNING! The connection was not in the connecting state."), l._.connectingMessageBuffer.drain(), n(l).triggerHandler(u.onStart), e.bind("unload", function() {
                                l.log("Window unloading, stopping the connection."), l.stop(f)
                        ...
                        l.log(h.name + " transport threw '" + w.message + "' when attempting to start."), v()
                    }
                }
            ...
            }, n(l).triggerHandler(u.onStarting), k = r.transports._logic.prepareQueryString(l, k), l.log("Negotiating with '" + k + "'."), l._.negotiateRequest = r.transports._logic.ajax(l, {
                url: k,
                error: function(n, t) {
                    t !== c ? g(n, l) : y.reject(r._.error(f.stoppedWhileNegotiating, null, l._.negotiateRequest))
                },
                success: function(t) {
                    var i, e, h, o = [],
                        s = [];
                    ...
                    if (e = l._.keepAliveData, l.appRelativeUrl = i.Url, l.id = i.ConnectionId, l.token = i.ConnectionToken, l.webSocketServerUrl = i.WebSocketServerUrl, l._.pollTimeout = i.ConnectionTimeout * 1e3 + 1e4, l.disconnectTimeout = i.DisconnectTimeout * 1e3, l._.totalTransportConnectTimeout = l.transportConnectTimeout + i.TransportConnectTimeout * 1e3, i.KeepAliveTimeout ? (e.activated = !0, e.timeout = i.KeepAliveTimeout * 1e3, e.timeoutWarning = e.timeout * l.keepAliveWarnAt, l._.beatInterval = (e.timeout - e.timeoutWarning) / 3) : e.activated = !1, l.reconnectWindow = l.disconnectTimeout + (e.timeout || 0), !i.ProtocolVersion || i.ProtocolVersion !== l.clientProtocol) {
                        h = r._.error(r._.format(f.protocolIncompatible, l.clientProtocol, i.ProtocolVersion)), n(l).triggerHandler(u.onError, [h]), y.reject(h);
                        return
                    }
                    ...
                    }) : v.transport === "auto" ? o = s : n.inArray(v.transport, s) >= 0 && o.push(v.transport), d(o)
                }
            }), y.promise())
        },
        starting: function(t) {
        ...
        stop: function(i, h) {
            ...
            if (l._.deferredStartHandler && e.unbind("load", l._.deferredStartHandler), delete l._.config, delete l._.deferredStartHandler, !s && (!l._.config || l._.config.waitForPageLoad === !0)) {
                l.log("Stopping connection prior to negotiate."), v && v.reject(r._.error(f.stoppedWhileLoading));
                return
            }
            if (l.state !== r.connectionState.disconnected) return l.log("Stopping connection."), o(l, l.state, r.connectionState.disconnected), t.clearTimeout(l._.beatHandle), t.clearInterval(l._.pingIntervalId), l.transport && (l.transport.stop(l), h !== !1 && l.transport.abort(l, i), a(l) && r.transports._logic.stopMonitoringKeepAlive(l), l.transport = null), l._.negotiateRequest && (l._.negotiateRequest.abort(c), delete l._.negotiateRequest), l._.initHandler && l._.initHandler.stop(), n(l).triggerHandler(u.onDisconnect), delete l._deferral, delete l.messageId, delete l.groupsToken, delete l.id, delete l._.pingIntervalId, delete l._.lastMessageAt, delete l._.lastActiveAt, l._.connectingMessageBuffer.clear(), l
        },
        log: function(n) {
            y(n, this.logging)
        }
...
function(n, t, i) {
    function s(n) {
        n._.keepAliveData.monitoring && l(n), u.markActive(n) && (n._.beatHandle = t.setTimeout(function() {
            s(n)
        }, n._.beatInterval))
    }
    ...
    function h(n) {
        this.connection = n, this.startRequested = !1, this.startCompleted = !1, this.connectionStopped = !1
    }
    var r = n.signalR,
        f = n.signalR.events,
    ...
    r.transports = {}, h.prototype = {
        start: function(n, r, u) {
            ...
            e.log(n.name + " transport starting."), f.transportTimeoutHandle = t.setTimeout(function() {
                o || (o = !0, e.log(n.name + " transport timed out when trying to connect."), f.transportFailed(n, i, u))
            }, e._.totalTransportConnectTimeout), n.start(e, function() {
        ...
        stop: function() {
            this.connectionStopped = !0, t.clearTimeout(this.transportTimeoutHandle), r.transports._logic.tryAbortStartRequest(this.connection)
        },
        ...
        processMessages: function(t, i, r) {
            var f;
            u.markLastMessage(t), i && (f = u.maximizePersistentResponse(i), u.updateGroups(t, f.GroupsToken), f.MessageId && (t.messageId = f.MessageId), f.Messages && (n.each(f.Messages, function(n, i) {
                u.triggerReceived(t, i)
            }), u.tryInitialize(f, r)))
        },
        ...
        startHeartbeat: function(n) {
            n._.lastActiveAt = +new Date, s(n)
        },
        markLastMessage: function(n) {
            n._.lastMessageAt = +new Date
        },
        markActive: function(n) {
            return u.verifyLastActive(n) ? (n._.lastActiveAt = +new Date, !0) : !1
        },
...
function(n, t) {
    ...
    u.transports.webSockets = {
        ...
        send: function(t, i) {
            var e = r.stringifySend(t, i);
            try {
                t.socket.send(e)
            } catch (o) {
                n(t).triggerHandler(f.onError, [u._.transportError(u.resources.webSocketsInvalidState, t.transport, o, t.socket), i])
            }
        },
        start: function(i, o, s) {
            var h, c = !1,
                l = this,
                a = !o,
                v = n(i);
            ...
            i.socket || (h = i.webSocketServerUrl ? i.webSocketServerUrl : i.wsProtocol + i.host, h += r.getUrl(i, this.name, a), i.log("Connecting to websocket endpoint '" + h + "'."), i.socket = new t.WebSocket(h), i.socket.onopen = function() {
                c = !0, i.log("Websocket opened."), r.clearReconnectTimeout(i), e(i, u.connectionState.reconnecting, u.connectionState.connected) === !0 && v.triggerHandler(f.onReconnect)
            }, i.socket.onclose = function(t) {
                var r;
                this === i.socket && (c && typeof t.wasClean != "undefined" && t.wasClean === !1 ? (r = u._.transportError(u.resources.webSocketClosed, i.transport, t), i.log("Unclean disconnect from websocket: " + (t.reason || "[no reason given]."))) : i.log("Websocket closed."), s && s(r) || (r && n(i).triggerHandler(f.onError, [r]), l.reconnect(i)))
            }, i.socket.onmessage = function(t) {
                var u;
                try {
                    u = i._parseResponse(t.data)
                } catch (f) {
                    r.handleParseFailure(i, t.data, f, s, t);
                    return
                }
                u && (n.isEmptyObject(u) || u.M ? r.processMessages(i, u, o) : r.triggerReceived(i, u))
            })
        },
        ...
        stop: function(n) {
            r.clearReconnectTimeout(n), n.socket && (n.log("Closing the Websocket."), n.socket.close(), n.socket = null)
        },
        abort: function(n, t) {
            r.ajaxAbort(n, t)
        }
...
function(n, t) {
    ...
    r.transports.serverSentEvents = {
        ...
        timeOut: 3e3,
        start: function(i, s, h) {
            var c = this,
                l = !1,
                a = n(i),
                v = !s,
                y;
            if (i.eventSource && (i.log("The connection already has an event source. Stopping it."), i.stop()), !t.EventSource) {
                h && (i.log("This browser doesn't support SSE."), h());
                return
            }
            y = u.getUrl(i, this.name, v);
            try {
                i.log("Attempting to connect to SSE endpoint '" + y + "'."), i.eventSource = new t.EventSource(y, {
                    withCredentials: i.withCredentials
                })
            } catch (p) {
                i.log("EventSource failed trying to connect with error " + p.Message + "."), h ? h() : (a.triggerHandler(f.onError, [r._.transportError(r.resources.eventSourceFailedToConnect, i.transport, p)]), v && c.reconnect(i));
                return
            }
            v && (i._.reconnectAttemptTimeoutHandle = t.setTimeout(function() {
                l === !1 && i.eventSource.readyState !== t.EventSource.OPEN && c.reconnect(i)
            }, c.timeOut)), i.eventSource.addEventListener("open", function() {
                i.log("EventSource connected."), e(i), u.clearReconnectTimeout(i), l === !1 && (l = !0, o(i, r.connectionState.reconnecting, r.connectionState.connected) === !0 && a.triggerHandler(f.onReconnect))
            }, !1), i.eventSource.addEventListener("message", function(n) {
                var t;
                if (n.data !== "initialized") {
                    try {
                        t = i._parseResponse(n.data)
                    } catch (r) {
                        u.handleParseFailure(i, n.data, r, h, n);
                        return
                    }
                    u.processMessages(i, t, s)
                }
            }, !1), i.eventSource.addEventListener("error", function(n) {
                var u = r._.transportError(r.resources.eventSourceError, i.transport, n);
                this === i.eventSource && (h && h(u) || (i.log("EventSource readyState: " + i.eventSource.readyState + "."), n.eventPhase === t.EventSource.CLOSED ? (i.log("EventSource reconnecting due to the server connection ending."), c.reconnect(i)) : (i.log("EventSource error."), a.triggerHandler(f.onError, [u]))))
            }, !1)
        },
        reconnect: function(n) {
            u.reconnect(n, this.name)
        },
        lostConnection: function(n) {
            this.reconnect(n)
        },
        ...
        stop: function(n) {
            e(n), u.clearReconnectTimeout(n), n && n.eventSource && (n.log("EventSource calling close()."), n.eventSource.close(), n.eventSource = null, delete n.eventSource)
        },
        abort: function(n, t) {
            u.ajaxAbort(n, t)
        }
...
function(n, t) {
    var u = n.signalR,
        ...
        e = function() {
            ...
            return {
                prevent: function() {
                    u._.ieVersion <= 8 && (n === 0 && (i = t.setInterval(function() {
                        var n = f();
    ...
    u.transports.foreverFrame = {
        ...
        start: function(n, i, u) {
            var l = this,
                s = r.foreverFrame.count += 1,
                h, o = f(),
                c = function() {
                    n.log("Forever frame iframe finished loading and is no longer receiving messages."), u && u() || l.reconnect(n)
                };
            if (t.EventSource) {
                u && (n.log("Forever Frame is not supported by SignalR on browsers with SSE support."), u());
                return
            }
            o.setAttribute("data-signalr-connection-id", n.id), e.prevent(), h = r.getUrl(n, this.name), h += "&frameId=" + s, t.document.documentElement.appendChild(o), n.log("Binding to iframe's load event."), o.addEventListener ? o.addEventListener("load", c, !1) : o.attachEvent && o.attachEvent("onload", c), o.src = h, r.foreverFrame.connections[s] = n, n.frame = o, n.frameId = s, i && (n.onSuccess = function() {
                n.log("Iframe transport started."), i()
            })
        },
        reconnect: function(n) {
            var i = this;
            r.isConnectedOrReconnecting(n) && r.verifyLastActive(n) && t.setTimeout(function() {
                if (r.verifyLastActive(n) && n.frame && r.ensureReconnectingState(n)) {
                    var u = n.frame,
                        t = r.getUrl(n, i.name, !0) + "&frameId=" + n.frameId;
        ...
        receive: function(t, i) {
            var f, e, o;
            if (t.json !== t._originalJson && (i = t._originalJson.stringify(i)), o = t._parseResponse(i), r.processMessages(t, o, t.onSuccess), t.state === n.signalR.connectionState.connected && (t.frameMessageCount = (t.frameMessageCount || 0) + 1, t.frameMessageCount > u.transports.foreverFrame.iframeClearThreshold && (t.frameMessageCount = 0, f = t.frame.contentWindow || t.frame.contentDocument, f && f.document && f.document.body)))
        ...
        stop: function(n) {
            ...
            if (e.cancel(), n.frame) {
                if (n.frame.stop) n.frame.stop();
                    ...
                    i = n.frame.contentWindow || n.frame.contentDocument, i.document && i.document.execCommand && i.document.execCommand("Stop")
                } catch (u) {
                    n.log("Error occured when stopping foreverFrame transport. Message = " + u.message + ".")
                }
                n.frame.parentNode === t.document.body && t.document.body.removeChild(n.frame), delete r.foreverFrame.connections[n.frameId], n.frame = null, n.frameId = null, delete n.frame, delete n.frameId, delete n.onSuccess, delete n.frameMessageCount, n.log("Stopping forever frame.")
            }
        },
        abort: function(n, t) {
            r.ajaxAbort(n, t)
        ...
        getConnection: function(n) {
            return r.foreverFrame.connections[n]
        },
        started: function(t) {
            s(t, u.connectionState.reconnecting, u.connectionState.connected) === !0 && n(t).triggerHandler(o.onReconnect)
        }
    }
}(window.jQuery, window),
function(n, t) {
    var u = n.signalR,
        f = n.signalR.events,
        o = n.signalR.changeState,
        e = n.signalR.isDisconnecting,
        r = u.transports._logic;
    u.transports.longPolling = {
        name: "longPolling",
        supportsKeepAlive: function() {
            return !1
        },
        ...
        start: function(i, s, h) {
            var a = this,
                v = function() {
                    v = n.noop, i.log("LongPolling connected."), s()
                },
                y = function(n) {
                    return h(n) ? (i.log("LongPolling failed to connect."), !0) : !1
                },
                c = i._,
                l = 0,
                p = function(i) {
                    t.clearTimeout(c.reconnectTimeoutId), c.reconnectTimeoutId = null, o(i, u.connectionState.reconnecting, u.connectionState.connected) === !0 && (i.log("Raising the reconnect event"), n(i).triggerHandler(f.onReconnect))
                },
                w = 36e5;
            i.pollXhr && (i.log("Polling xhr requests already exists, aborting."), i.stop()), i.messageId = null, c.reconnectTimeoutId = null, c.pollTimeoutId = t.setTimeout(function() {
                (function o(s, h) {
                    var g = s.messageId,
                        nt = g === null,
                        k = !nt,
                        tt = !h,
                        d = r.getUrl(s, a.name, k, tt, !0),
                        b = {};
                    (s.messageId && (b.messageId = s.messageId), s.groupsToken && (b.groupsToken = s.groupsToken), e(s) !== !0) && (i.log("Opening long polling request to '" + d + "'."), s.pollXhr = r.ajax(i, {
                        xhrFields: {
                            onprogress: function() {
                                r.markLastMessage(i)
                            }
                        ...
                        url: d,
                        type: "POST",
                        contentType: u._.defaultContentType,
                        data: b,
                        timeout: i._.pollTimeout,
                        success: function(u) {
                            var h, w = 0,
                                f, a;
                            i.log("Long poll complete."), l = 0;
                            try {
                                h = i._parseResponse(u)
                            } catch (b) {
                                r.handleParseFailure(s, u, b, y, s.pollXhr);
                                return
                            }(c.reconnectTimeoutId !== null && p(s), h && (f = r.maximizePersistentResponse(h)), r.processMessages(s, h, v), f && n.type(f.LongPollDelay) === "number" && (w = f.LongPollDelay), e(s) !== !0) && (a = f && f.ShouldReconnect, !a || r.ensureReconnectingState(s)) && (w > 0 ? c.pollTimeoutId = t.setTimeout(function() {
                                o(s, a)
                            }, w) : o(s, a))
                        },
                        error: function(e, h) {
                            var v = u._.transportError(u.resources.longPollFailed, i.transport, e, s.pollXhr);
                            if (t.clearTimeout(c.reconnectTimeoutId), c.reconnectTimeoutId = null, h === "abort") {
                                i.log("Aborted xhr request.");
                                return
                            }
                            if (!y(v)) {
                                if (l++, i.state !== u.connectionState.reconnecting && (i.log("An error occurred using longPolling. Status = " + h + ".  Response = " + e.responseText + "."), n(s).triggerHandler(f.onError, [v])), (i.state === u.connectionState.connected || i.state === u.connectionState.reconnecting) && !r.verifyLastActive(i)) return;
...
function(n) {
    ...
    function o(n, t) {
        var i = n._.invocationCallbacks,
            r, u;
        e(i) && n.log("Clearing hub invocation callbacks with error: " + t + "."), n._.invocationCallbackId = 0, delete n._.invocationCallbacks, n._.invocationCallbacks = {};
        for (u in i) r = i[u], r.method.call(r.scope, {
            E: t
        })
    }
    ...
    function r(t, i) {
        ...
        return n.extend(u, i), (!t || u.useDefaultPath) && (t = (t || "") + "/signalr"), new r.fn.init(t, u)
    }
    var s = ".hubProxy",
        h = n.signalR;
    u.fn = u.prototype = {
        ...
        on: function(t, i) {
            ...
            return t = t.toLowerCase(), u[t] || (u[t] = {}), u[t][i] = function(n, t) {
                i.apply(r, t)
            }, n(r).bind(f(t), u[t][i]), r
        },
        off: function(t, i) {
            var u = this,
                o = u._.callbackMap,
                r;
            return t = t.toLowerCase(), r = o[t], r && (r[i] ? (n(u).unbind(f(t), r[i]), delete r[i], e(r) || delete o[t]) : i || (n(u).unbind(f(t)), delete o[t])), u
        },
        invoke: function(t) {
            var i = this,
                r = i.connection,
    ...
    }, u.fn.init.prototype = u.fn, r.fn = r.prototype = n.connection(), r.fn.init = function(t, i) {
        var u = {
                qs: null,
                logging: !1,
                useDefaultPath: !0
            ...
            r = this;
        n.extend(u, i), n.signalR.fn.init.call(r, t, u.qs, u.logging), r.proxies = {}, r._.invocationCallbackId = 0, r._.invocationCallbacks = {}, r.received(function(t) {
            var u, o, e, i, s, h;
            t && (typeof t.P != "undefined" ? (e = t.P.I.toString(), i = r._.invocationCallbacks[e], i && i.method.call(i.scope, t)) : typeof t.I != "undefined" ? (e = t.I.toString(), i = r._.invocationCallbacks[e], i && (r._.invocationCallbacks[e] = null, delete r._.invocationCallbacks[e], i.method.call(i.scope, t))) : (u = this._maximizeClientHubInvocation(t), r.log("Triggering client hub event '" + u.Method + "' on hub '" + u.Hub + "'."), s = u.Hub.toLowerCase(), h = u.Method.toLowerCase(), o = this.proxies[s], n.extend(o.state, u.State), n(o).triggerHandler(f(h), [u.Args])))
        }), r.error(function(n, t) {
            var i, u;
            t && (i = t.I, u = r._.invocationCallbacks[i], u && (r._.invocationCallbacks[i] = null, delete r._.invocationCallbacks[i], u.method.call(u.scope, {
                E: n
            })))
        }), r.reconnecting(function() {
            r.transport && r.transport.name === "webSockets" && o(r, "Connection started reconnecting before invocation result was received.")
        }), r.disconnected(function() {
            o(r, "Connection was disconnected before invocation result was received.")
        })
    }, r.fn._maximizeClientHubInvocation = function(n) {
        return {
            Hub: n.H,
            Method: n.M,
            Args: n.A,
    ...
    }, r.fn._registerSubscribedHubs = function() {
        var t = this;
    ...
    }, r.fn.createHubProxy = function(n) {
        n = n.toLowerCase();
        var t = this.proxies[n];
        return t || (t = u(this, n), this.proxies[n] = t), this._registerSubscribedHubs(), t
    }, r.fn.init.prototype = r.fn, n.hubConnection = r
}(window.jQuery, window),
function(n) {
