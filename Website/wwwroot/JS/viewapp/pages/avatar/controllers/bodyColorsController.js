...
avatar.controller("bodyColorsController", ["$scope", "$log", "$timeout", "$q", "avatarService", "robloxModalService", "avatarConstants", "googleAnalyticsEventsService", "$rootScope", function(n, t, i, r, u, f, e, o, s) {
    function v(t, i) {
        var r = i.brickColorId,
            u = n.myBodyColors;
        switch (t.name) {
            case "all":
                u.headColorId = r, u.torsoColorId = r, u.leftArmColorId = r, u.rightArmColorId = r, u.leftLegColorId = r, u.rightLegColorId = r;
                break;
            case "headColorId":
                u.headColorId = r;
                break;
    ...
    function y(n) {
        var t = n.headColorId;
        return n.headColorId === t && n.torsoColorId === t && n.rightArmColorId === t && n.leftArmColorId === t && n.rightLegColorId === t && n.leftLegColorId === t
    }
    ...
    function w() {
        return u.setBodyColors(n.myBodyColors).then(function() {
            s.$broadcast(e.events.bodyColorsChanged, n.myBodyColors), n.refreshThumbnail()
        }, function() {
    ...
    function a() {
        var n = e.googleAnalytics.closeLabel;
        h && (n = e.googleAnalytics.saveLabel), o.fireEvent(e.googleAnalytics.category, e.googleAnalytics.advancedBodyColorsAction, n)
    }
    n.myBodyColors = {
        headColorId: 0,
        torsoColorId: 0,
    ...
    var c = n.bodyParts[0],
        h = !1;
    n.colorsPalette = [], n.advancedPalette = [], n.isColorSelected = function(t) {
        return t.brickColorId === n.currentColorId
    }, n.onColorDotClicked = function(n, t) {
        return typeof t == "undefined" && (t = c), v(t, n), h = !0, w()
    }, n.openAdvancedBodyColors = function() {
        t.debug("advanced body colors"), h = !1;
        var r = "advanced-body-colors-modal",
            i = {
