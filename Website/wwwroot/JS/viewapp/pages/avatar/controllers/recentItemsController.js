...
avatar.controller("recentItemsController", ["$scope", "$log", "$timeout", "$q", "avatarService", "avatarConstants", function(n, t, i, r, u, f) {
    ...
    function s() {
        !h() || e || n.loading || (n.loading = !0, n.items = [], u.getRecentItems(o).then(function(t) {
            var i, r;
            for (n.items = [], i = 0; i < t.data.length; i++) r = t.data[i], n.addItemThumbnailAndLink(r), n.updateItemSelected(r);
            n.items = t.data, n.loading = !1, e = !0
        }, function() {
            n.systemFeedback.error(f.recent.couldNotLoadList)
        }))
    }
    n.loading = !1, n.items = [], n.emptyMessage = f.recent.emptyMessage;
    var o = "All",
        e = !1;
    n.$on(f.events.wornAssetsChanged, function() {
