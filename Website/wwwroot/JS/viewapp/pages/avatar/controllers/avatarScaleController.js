...
avatar.controller("avatarScaleController", ["$scope", "$log", "$timeout", "$q", "avatarService", "avatarConstants", function(n, t, i, r, u, f) {
    ...
    n.scales = {
        ...
        t.debug("updateScales");
        var i = {
            height: n.scales.height.value / 100,
            width: n.scales.width.value / 100
        };
    ...
    var h = !1,
        e = null;
    n.$on(f.events.metaDataLoaded, function(i, r) {
        t.debug("Meta data loaded for scale controller"), n.scales.height.increment = r.scaleHeightIncrement * 100, n.scales.width.increment = r.scaleWidthIncrement * 100, r.scaleHeadEnabled && (n.scales.head = {
            label: "Head",
            min: 0,
            max: 100,
            value: 100,
            increment: 5
        }, n.scales.head.increment = r.scaleHeadIncrement * 100, n.scaleHeadEnabled = !0)
    }), n.$on(f.events.avatarRulesLoaded, function(i, r) {
