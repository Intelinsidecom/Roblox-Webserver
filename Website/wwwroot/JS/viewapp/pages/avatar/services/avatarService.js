...
avatar.factory("avatarService", ["$log", "$q", "httpService", "avatarUrlConstants", function(n, t, i, r) {
    ...
    var e = angular.element(document).find("#avatar-data-model").data("avatar-domain"),
        h = {
            getOutfitDetailsUrl: "/v1/outfits/{id}/details",
            createOutfitUrl: "/v1/outfits/create",
            deleteOutfitUrl: "/v1/outfits/{id}/delete",
            patchOutfitUrl: "/v1/outfits/{id}",
    ...
    return {
        ...
        patchOutfit: function(t, r) {
            n.debug("Patch outfit");
            var e = f(u.patchOutfitUrl, {
                    id: t
                }),
                o = {
                    url: e,
